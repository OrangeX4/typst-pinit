...
A more complex example, Have a look at the source [here](./examples/equation-desc.typ). (please waiting for version 0.1.2 to use it, version 0.1.1 doesn't support using em as unit of arrow function)
